...
<template>
    <footer class="footer p-10 bg-neutral text-neutral-content">
        <div>
            ...
            <p>King Mongkut's University of Technology Thonburi (KMUTT)<br>School of Information Technology (SIT)</p>
        </div>
        <div>
            <span class="footer-title" id="contact">Contact</span>
            <div class="grid grid-flow-row gap-4">
                <div class="grid grid-cols-2 w-48">
                    <a class="w-min"><svg width="24" height="24" viewBox="0 0 16 16">
                    ...
                    <span class="underline underline-offset-1 w-48"><a
                            href="tel:+66917026787">(+66)91-702-6787</a></span>
                </div>
                <div class="grid grid-cols-2 w-48">
                    ...
                    <span class="underline underline-offset-1"><a
                            href="mailto:jirasin.qc@gmail.com">jirasin.qc@gmail.com</a>
                    </span>
                </div>
                <div class="grid grid-cols-2 w-48">
                    <a>
                    ...
                    <span class="w-40">504/15, YuDee 20/1, Chan43 Road, Bangkhlo, Bangkolaem District, Bangkok, 10120
                    </span>
                </div>
                <div class="grid grid-cols-2 w-48">
                    <a>
                    ...
                    <span class="underline underline-offset-1 w-40"><a href="http://github.com/jirasin-c"
                            target="_blank" rel="noopener noreferrer">github.com/jirasin-c</a> </span>
                </div>
            </div>
        </div>
    </footer>
